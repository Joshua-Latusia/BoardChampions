...
void init()
{
	...
	field->addComponent(new PlayingFieldComponent(10.0f, "background.png"));
	field->scale = Vec3f(2.0f, 1.0f, 1.0f);
	field->position = Vec3f(0.0f, 0.0f, 0.0f);
	objects.push_back(field);

	//Add moveable cube
	GameObject* gObj = new GameObject();
	gObj->addComponent(new CubeComponent(0.5f));
	gObj->addComponent(new MoveComponent());
	gObj->addComponent(new SpinComponent(90.0f));
	gObj->position = Vec3f(0.0f, 0.0f, 0.25f);
